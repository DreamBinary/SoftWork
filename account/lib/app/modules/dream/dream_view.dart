                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                            ...
                            return AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.pop(
                                        context, int.parse(moneyCtrl.text));
                                  },
                        ...
                        print("money: $money");
                        await logic.saveMoney(money);
                        ctrl.forward(from: 0);
                      },
                      child: Transform.scale(
                        scale: 2,
                        child: Lottie.asset(AssetsRes.COIN,
                        ...
                        child: Stack(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Lottie.asset(AssetsRes.COIN_DANCE,
                                  controller: ctrl),
                            ),
                            StatefulBuilder(
          ...
          children: [
            ElevatedButton(
              style: ButtonStyle(
                  ...
                  backgroundColor:
                      MaterialStatePropertyAll(AppColors.color_list.first)),
              onPressed: () {
              ...
              child: Padding(
                ...
                child: Text("取消",
                    style: AppTS.normal.copyWith(
                        color:
                            AppColors.textColor(AppColors.color_list.first))),
              ),
            ),
            ElevatedButton(
              style: ButtonStyle(
              ...
              onPressed: () {
                widget.onConfirm
                    ?.call(_nameCtrl.text, date, num.parse(_moneyCtrl.text));
              },
              child: Padding(
                padding: const EdgeInsets.all(10),
                child: Text("确定",
